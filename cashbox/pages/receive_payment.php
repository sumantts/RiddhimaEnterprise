                        ...
                        <div class="row">
							...
							<div class="col-lg-12 d-none" id="paymentRcvDiv">
								<form action="#" method="POST" name="myForm1" id="myForm1">
									<div class="form-row">
										<div class="form-group col-md-3">
											<label for="collectionAmount" class="text-danger">Amount*</label>
											<input type="number" class="form-control" id="collectionAmount" name="collectionAmount" value="" required>
										</div>
										<div class="form-group col-md-3">
											<label for="collectionDate" class="text-danger">Date*</label>
											<input type="date" class="form-control" id="collectionDate" name="collectionDate" value="<?=date('Y-m-d')?>" required>
										</div>
										<div class="form-group col-md-3">
											<label for="collectionNote">Note</label>
											<input type="text" class="form-control" id="collectionNote" name="collectionNote" value="" >
										</div>
