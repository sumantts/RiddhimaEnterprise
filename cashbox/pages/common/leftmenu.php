	...
	<nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
		<div class="sb-sidenav-menu">
			<div class="nav">
				...
				<a class="nav-link collapsed <?php if($p == 'emp-list' || $p == 'emp-attendance' || $p == 'emp-pay'){?>active<?php } ?>" href="#" data-toggle="collapse" data-target="#collapseLayouts3" aria-expanded="false" aria-controls="collapseLayouts3">
					<div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
					Employee Accounts
					<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
				</a>
				<div class="collapse  <?php if($p == 'emp-list' || $p == 'emp-attendance' || $p == 'emp-pay'){?>show<?php } ?>" id="collapseLayouts3" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
					<nav class="sb-sidenav-menu-nested nav">
					...
					<a class="nav-link <?php if($p == 'emp-pay'){?>active<?php } ?>" href="?p=emp-pay">Pay</a>				
					</nav>
				</div>
